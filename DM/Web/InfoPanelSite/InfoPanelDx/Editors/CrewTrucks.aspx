<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Member.master" Async="true" CodeBehind="CrewTrucks.aspx.cs" Inherits="InfoPanelDx.Editors.CrewTrucks" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="TruckId" Caption="Truck" VisibleIndex="4">
