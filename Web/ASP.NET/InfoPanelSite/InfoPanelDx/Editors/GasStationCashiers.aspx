<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Member.master" Async="true" CodeBehind="GasStationCashiers.aspx.cs" Inherits="InfoPanelDx.Editors.GasStationCashiers" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="CashierId" Caption="Cashier" VisibleIndex="4">
