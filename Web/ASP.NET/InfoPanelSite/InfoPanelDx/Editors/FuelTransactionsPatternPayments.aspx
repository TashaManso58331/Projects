<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Patterns.Master" Async="true" CodeBehind="FuelTransactionsPatternPayments.aspx.cs" Inherits="InfoPanelDx.Editors.FuelTransactionsPatternPayments" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="FuelTransactionsPatternId" Caption="FuelTransactionsPatternId" VisibleIndex="3">
