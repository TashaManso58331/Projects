<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" Async="true" CodeBehind="Injectors.aspx.cs" Inherits="InfoPanelDx.Editors.Injectors" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataSpinEditColumn FieldName="QualityLevel" VisibleIndex="3">
