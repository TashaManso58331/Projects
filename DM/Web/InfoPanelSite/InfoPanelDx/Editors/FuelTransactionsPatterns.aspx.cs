...
{
    public partial class FuelTransactionsPatterns : System.Web.UI.Page {

        FuelTransactionsPatternManager manager;

        protected void Page_Load(object sender, EventArgs e) {
            manager = FuelTransactionsPatternManager.DefaultManager;
