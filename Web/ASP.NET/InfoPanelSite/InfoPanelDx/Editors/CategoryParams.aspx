<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/CStores.Master" Async="true" CodeBehind="CategoryParams.aspx.cs" Inherits="InfoPanelDx.Editors.CategoryParams" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="CategoryId" Caption="Category" VisibleIndex="1">
