<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Price.master" Async="true" CodeBehind="Cashbacks.aspx.cs" Inherits="InfoPanelDx.Editors.Cashbacks" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="Formula" VisibleIndex="7">
