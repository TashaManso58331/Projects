<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Patterns.Master" Async="true" CodeBehind="GasStationChainPatterns.aspx.cs" Inherits="InfoPanelDx.Editors.GasStationChainPatterns" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="GasStationChainId" Caption="GasStationChain" VisibleIndex="3">
