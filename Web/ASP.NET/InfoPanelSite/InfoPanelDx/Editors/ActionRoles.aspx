<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" Async="true" CodeBehind="ActionRoles.aspx.cs" Inherits="InfoPanelDx.Editors.ActionRoles" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="ActionId" Caption="Name" VisibleIndex="3">
