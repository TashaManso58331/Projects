<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/ACH.Master" Async="true" CodeBehind="ACHBalanceSellers.aspx.cs" Inherits="InfoPanelDx.Editors.ACHBalanceSellers" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        <dx:GridViewDataComboBoxColumn FieldName="MemberBeneficiaryId" Caption="Member" VisibleIndex="2">
