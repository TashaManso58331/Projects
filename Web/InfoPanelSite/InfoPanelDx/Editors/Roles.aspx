<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" Async="true" CodeBehind="Roles.aspx.cs" Inherits="InfoPanelDx.Editors.Roles" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn Caption="Role" FieldName="Name" VisibleIndex="2">
