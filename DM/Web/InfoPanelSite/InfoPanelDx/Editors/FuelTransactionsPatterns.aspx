<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Patterns.master" Async="true" CodeBehind="FuelTransactionsPatterns.aspx.cs" Inherits="InfoPanelDx.Editors.FuelTransactionsPatterns" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="UserFriendlyName" VisibleIndex="3">
        </dx:GridViewDataTextColumn>
