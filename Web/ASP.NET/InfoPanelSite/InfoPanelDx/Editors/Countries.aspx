<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" Async="true" CodeBehind="Countries.aspx.cs" Inherits="InfoPanelDx.Editors.Countries" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="CurrencyId" Caption="Currency" VisibleIndex="4">
            <PropertiesComboBox TextField="FullName" ValueField="Id">
            </PropertiesComboBox>
        </dx:GridViewDataComboBoxColumn> 
        <dx:GridViewDataComboBoxColumn FieldName="WireCardCode" Caption="WireCard Code" VisibleIndex="5">
            <PropertiesComboBox TextField="Code" ValueField="Code">
            </PropertiesComboBox>
        </dx:GridViewDataComboBoxColumn> 
    </Columns>
</dx:ASPxGridView>
