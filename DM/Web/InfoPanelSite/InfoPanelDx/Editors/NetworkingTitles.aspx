<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" Async="true" CodeBehind="NetworkingTitles.aspx.cs" Inherits="InfoPanelDx.Editors.NetworkingTitles" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="NetworkingTitleCategoryId" Caption="Networking Title Category" VisibleIndex="4">
