<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Main.master" Async="true" CodeBehind="MemberTypes.aspx.cs" Inherits="InfoPanelDx.Editors.MemberTypes" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataTextColumn FieldName="Name" Caption="System Value" VisibleIndex="2">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataTextColumn Caption="Identificator for language resources" FieldName="FriendlyName" VisibleIndex="3">
        </dx:GridViewDataTextColumn>
        <dx:GridViewDataCheckColumn  Caption="Is Visible For Sign Up (Landing)" FieldName="IsVisibleForSignUp" VisibleIndex="4">
