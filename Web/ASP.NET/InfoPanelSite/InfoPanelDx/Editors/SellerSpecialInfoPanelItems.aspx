<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Price.master" Async="true" CodeBehind="SellerSpecialInfoPanelItems.aspx.cs" Inherits="InfoPanelDx.Editors.SellerSpecialInfoPanelItems" %>
...
<dx:ASPxGridView ID="gv" runat="server" AutoGenerateColumns="False" ClientInstanceName="gv"
    ...
    <Columns>
        ...
        <dx:GridViewDataComboBoxColumn FieldName="MemberId" Caption="Seller" VisibleIndex="4">
